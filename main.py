...
´´´´´´´´´´´´´´´´´´´´´´¶¶¶¶´´¶¶¶¶¶´´¶¶¶¶´´´´´´´´´´´´´´´´´´´´´
    ...
    print(Colorate.Horizontal(getattr(Colors, theme), f"WLC TO TOOL INFERNUM SQUAD"))
    ...
    if choix == "1":
        ...
        print(Colorate.Horizontal(getattr(Colors, theme), "Devoleper: Self$"))
        print(Colorate.Horizontal(getattr(Colors, theme), "Discord server: https://discord.gg/infernumsquad"))
        print(Colorate.Horizontal(getattr(Colors, theme), "github: https://github.com/S1lf1z"))
        input(Colorate.Horizontal(getattr(Colors, theme), "Appuyez sur Entrée pour revenir au menu : "))
        clear_screen() 
        main_menu()
    else:
